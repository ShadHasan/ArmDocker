...
class RKLLM(object):
    ...
    def release_with_cache(self, prompt_cache_path):
        self.prompt_cache_path = None
        if prompt_cache_path:
            self.prompt_cache_path = prompt_cache_path

            rkllm_save_prompt_cache = rkllm_lib.rkllm_save_prompt_cache
            rkllm_save_prompt_cache.argtypes = [RKLLM_Handle_t, ctypes.c_char_p]
            rkllm_save_prompt_cache.restype = ctypes.c_int
            rkllm_save_prompt_cache(self.handle, ctypes.c_char_p((prompt_cache_path).encode('utf-8')))
        self.rkllm_destroy(self.handle)
...
if __name__ == "__main__":
    ...
    def shutdown_handler(signum, frame):
        ...
        # rkllm_model.release()
        rkllm_model.release_with_cache("/mnt/nvme01/rkllm_model/01_august_qwen_last.cache")
        print("====================")
        sys.exit(0)
